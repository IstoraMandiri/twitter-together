/**
 * A tweet whose publication failed is not retried while its file is unchanged.
 */
...
nock("https://api.github.com", {
  ...
  .put(LEDGER, (body) => {
    ...
    tap.equal(entries["tweets/scheduled.tweet"].status, "failed");
    return true;
  })
...
git.lastChange = () => "2020-01-01T00:00:00Z";
